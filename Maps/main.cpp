...
int main(){
    ...
    cout<< "size of unordered map is " <<my_dictionary.size()<< "\n";

    vector<int> myvector {1,55,90,960};
    for( int element: myvector){
        if(my_dictionary.find(element)== my_dictionary.end()){
            cout<<element <<" this number is not inserted yet"<< "\n";
        } else {
            cout <<element <<" is " <<my_dictionary[element]<< "\n";
        }
    }
    my_dictionary[960] = "Maldives";
    cout << "960" <<" is " <<my_dictionary[960]<< "\n";
